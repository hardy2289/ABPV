...
public class AddDetailsPHome extends AppCompatActivity {
    ...
    public void onCreate( Bundle savedInstanceState) {
        ...
        txtPhoneNo = (EditText) findViewById(R.id.editPhoneNo);
        btnSubmit = (Button) findViewById(R.id.btnAddDetails);

        ArrayAdapter<String> adapter = new ArrayAdapter<>(AddDetailsPHome.this, android.R.layout.select_dialog_singlechoice, state);
        txtGender = (AutoCompleteTextView) findViewById(R.id.editGender);
        ...
        txtDOB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatePicker = new DatePickerDialog(AddDetailsPHome.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (user == null) {
                                ...
                                Toast.makeText(AddDetailsPHome.this ,
                                ...
                                // Update User Details
                                    ...
                                    writeToProfile(authentication, sDateOfBirth, sEmail, sFirstName, sGender, sLastName, sPhoneNo, userId, sUserName);
                                    Toast.makeText(AddDetailsPHome.this, "Profile updated Successfully", Toast.LENGTH_LONG).show();
                                    Intent takeUserHome = new Intent(AddDetailsPHome.this, Navigation.class);
...
//this.finish();
    ...
    public void writeToProfile(String authentication,String dateofbirth, String email,String firstname, String gender, String lastname, String phoneno, String userId
            ,  String username ) {


       PersonalDetails personalDetails = new PersonalDetails(authentication, dateofbirth, email,firstname, gender,  lastname,phoneno,  userId, username  );
