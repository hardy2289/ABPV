...
public class GoogleLogin extends BaseActivity implements GoogleApiClient.OnConnectionFailedListener,
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull final Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Intent takeUserHome = new Intent(GoogleLogin.this, PatientLogin.class);
