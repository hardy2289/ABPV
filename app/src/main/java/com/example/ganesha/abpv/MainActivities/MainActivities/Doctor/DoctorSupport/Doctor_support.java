...
public class Doctor_support {
    ...
    public void setPatientContactNo(String patient_medication){
    ...
    public void setPatientEmail(String medicine_amount){
    ...
    public void setAppointmentNo(String medicine_dispence){
    ...
    public void setDoctorId(String medicine_refill){
